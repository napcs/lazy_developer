=LazyDeveloper
Copyright (C) 2007-2009 Brian P. Hogan and Kevin W. Gisi
...
It's easy to forget what generators you may have run. Now, script/generate commands along with nuke commands can all be logged. Run

  rake lazy:logger:install

to have these commands logged to log/generator.log. This hook can be uninstalled with

  rake lazy:logger:remove

Copyright (c) 2007-2009 Brian P. Hogan and Kevin W. Gisi. Released under the MIT license
