=LazyDeveloper
Copyright (C) 2007-2012 Brian P. Hogan, Kevin Gisi, and Jon Kinney
...
This gem supports Rails 3 and up.

== Installation

  gem install lazy_developer
  
or add it to your `gemfile` but only in the development and test groups.
